...
-- ----------------------------
BEGIN;
INSERT INTO "public"."reservations" ("id", "first_name", "last_name", "email", "phone", "start_date", "end_date", "room_id", "created_at", "updated_at") VALUES (1, 'test', 'test', 'test@gmail.com', '555-555-1234', '2020-11-30', '2020-12-30', 1, '2025-04-10 22:23:11.961518', '2025-04-10 22:23:11.961518');
INSERT INTO "public"."reservations" ("id", "first_name", "last_name", "email", "phone", "start_date", "end_date", "room_id", "created_at", "updated_at") VALUES (2, 'john', 'go', 'test@g.com', '555-555-1234', '2025-05-01', '2025-06-01', 1, '2025-04-10 22:40:09.055871', '2025-04-10 22:40:09.055871');
INSERT INTO "public"."reservations" ("id", "first_name", "last_name", "email", "phone", "start_date", "end_date", "room_id", "created_at", "updated_at") VALUES (3, 'Test001', 'Test001', 'test@mgil.com', '555-555-555', '2025-04-10', '2025-04-10', 1, '2025-04-11 17:54:45.40366', '2025-04-11 17:54:45.40366');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."restrictions" ("id", "restriction_name", "created_at", "updated_at") VALUES (1, 'Reservation', '2025-04-10 22:34:46', '2025-04-10 22:34:49');
INSERT INTO "public"."restrictions" ("id", "restriction_name", "created_at", "updated_at") VALUES (2, 'Owner Block', '2025-04-11 15:39:46', '2025-04-11 15:39:48');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."room_restrictions" ("id", "start_date", "end_date", "room_id", "reservation_id", "restriction_id", "created_at", "updated_at") VALUES (1, '2021-02-01', '2021-02-04', 1, 2, 1, '2025-04-10 22:40:09.058295', '2025-04-10 22:40:09.058295');
INSERT INTO "public"."room_restrictions" ("id", "start_date", "end_date", "room_id", "reservation_id", "restriction_id", "created_at", "updated_at") VALUES (2, '2021-02-01', '2021-02-04', 2, NULL, 2, '2025-04-11 16:43:29', '2025-04-11 16:43:31');
INSERT INTO "public"."room_restrictions" ("id", "start_date", "end_date", "room_id", "reservation_id", "restriction_id", "created_at", "updated_at") VALUES (3, '2025-04-10', '2025-04-10', 1, 3, 1, '2025-04-11 17:54:45.408183', '2025-04-11 17:54:45.408183');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."rooms" ("id", "room_name", "created_at", "updated_at") VALUES (1, 'General', '2025-04-10 22:21:12', '2025-04-10 22:21:18');
INSERT INTO "public"."rooms" ("id", "room_name", "created_at", "updated_at") VALUES (2, 'Major', '2025-04-11 16:41:09', '2025-04-11 16:41:12');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410075836');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410081207');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410081407');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410081547');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410081643');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410083137');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410084451');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410092653');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410092951');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250410094013');
INSERT INTO "public"."schema_migration" ("version") VALUES ('20250411084135');
COMMIT;
...
SELECT setval('"public"."reservations_id_seq"', 3, true);
...
SELECT setval('"public"."room_restrictions_id_seq"', 3, true);
