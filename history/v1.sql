...
-- ----------------------------
INSERT INTO "public"."reservations" VALUES (1, 'test', 'test', 'test@gmail.com', '555-555-1234', '2020-11-30', '2020-12-30', 1, '2025-04-10 22:23:11.961518', '2025-04-10 22:23:11.961518');
INSERT INTO "public"."reservations" VALUES (2, 'john', 'go', 'test@g.com', '555-555-1234', '2025-05-01', '2025-06-01', 1, '2025-04-10 22:40:09.055871', '2025-04-10 22:40:09.055871');
...
-- ----------------------------
INSERT INTO "public"."room_restrictions" VALUES (1, '2025-05-01', '2025-06-01', 1, 2, 1, '2025-04-10 22:40:09.058295', '2025-04-10 22:40:09.058295');
...
SELECT setval('"public"."reservations_id_seq"', 2, true);
...
SELECT setval('"public"."restrictions_id_seq"', 1, true);
...
SELECT setval('"public"."room_restrictions_id_seq"', 1, true);
...
SELECT setval('"public"."rooms_id_seq"', 1, false);
